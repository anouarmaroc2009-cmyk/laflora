export const SITE = {
  ...
  city: "Casablanca",
  country: "MA",
  tagline: "Atelier floral de luxe à Casablanca",
  ...
  description:
    "Fleuriste de luxe à Casablanca. Décoration florale de mariage, bouquets sur mesure, sculptures et installations d'événements. Contact : 06 82 72 50 55.",
  ogImage:
    "https://images.unsplash.com/photo-1469371670807-013ccf25f16a?auto=format&fit=crop&w=1200&h=630&q=80",
  ogImageAlt:
    "Décoration florale de mariage réalisée par LaFloraDelPatron, fleuriste de luxe à Casablanca",
} as const;
